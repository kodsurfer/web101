...
*   **Как получить обратную связь?** Есть два варианта:
    ...
    2.  **Отложенная проверка:** Отправьте файл в наш чат с хэштегом `#домашка`.

**Работа в пространстве «Билдин»**
Все материалы курса будут храниться в нашем рабочем пространстве в «Билдине» (китайский аналог Notion). Убедитесь, что у вас есть доступ. Там вы найдете:
...
**Задача на дом:**
Используя макет в Figma, который я выложу в «Билдин», визуально оформите вашу HTML-страницу. Вам нужно будет:
...
*   **Консультации** проходят по пятницам после пары. Записывайтесь в Telegram-чате.
